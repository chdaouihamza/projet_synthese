      ...
      <div class="pc">
        <div class="ps">
          ...
          <div style="margin:1rem 0">
            ...
            <p style="font-size:1.3rem;font-weight:bold;color:#2c6e2f"><strong>Total:</strong>
              $<?= number_format($tot, 2) ?></p>
          </div>
        </div>
        <div class="pf">
          <form action="confirm_booking.php" method="POST" id="paymentForm">
            <div class="cd">
              ...
              <div id="cs">
                ...
                <div class="cr">
                  <div style="flex:1"><label>Expiry Date</label><input type="text" class="ci" id="ex"
                      placeholder="MM/YY" required></div>
                  <div style="flex:1"><label>CVV</label><input type="text" class="ci" id="cv" placeholder="123"
                      required></div>
                </div>
              ...
              <button type="button" class="btn" style="width:100%" onclick="pay()">✅ Pay
                $<?= number_format($tot, 2) ?></button>
            </div>
          </form>
        </div>
      </div>
